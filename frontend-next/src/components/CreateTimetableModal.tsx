...
const timeSlotFormSchema = z
    .object({
        dayOfWeek: z.coerce.number().int().min(1).max(7),
        startTime: z
            .string()
            .optional()
            .refine((val) => !val || timeRegex.test(val), { message: invalidTimeMessage }),
        endTime: z
            .string()
            .optional()
            .refine((val) => !val || timeRegex.test(val), { message: invalidTimeMessage }),
...
const createTimetableFormSchema = z
    .object({
        ...
        validUntil: z
            .string()
            .regex(dateRegex, { message: invalidDateMessage })
            .optional()
            .or(z.literal(''))
            .nullable(),
            ...
            <DialogContent className="sm:max-w-[800px] max-h-[90vh] flex flex-col">
                ...
                <div className="flex items-end gap-2 border-b pb-4 mb-4">
                    <div className="flex-grow">
                        ...
                        >
                            ...
                            <SelectContent>
                                ...
                                {importableTimetables.length === 0 && !isLoadingImportList && (
                                    <SelectItem value="none" disabled>
                                        {' '}
                                        No previous timetables{' '}
                                    </SelectItem>
                                )}
                            </SelectContent>
                        </Select>
                    ...
                    <Button
                        ...
                        variant="outline"
                        size="sm"
                        disabled={!selectedImportId || isFetchingImportDetails}
                ...
                >
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                        <div>
                            <Label htmlFor="create-modal-name">
                                {' '}
                            ...
                            <Input
                                ...
                                {...register('name')}
                                placeholder="e.g., Sem 1 (Fall 2024)"
                        ...
                        <div>
                            <Label htmlFor="create-modal-validFrom">
                                {' '}
                                Valid From <span className="text-red-500">*</span>{' '}
                            </Label>
                            <Input
                                id="create-modal-validFrom"
                                type="date"
                                {...register('validFrom')}
                    ...
                    <div className="space-y-4 border-t pt-4">
                        <h3 className="text-base font-medium text-gray-700">
                            {' '}
                            Subjects & Schedules <span className="text-red-500">*</span>{' '}
                        </h3>
                    ...
                    <DialogFooter className="mt-6 pt-4 border-t sticky bottom-0 bg-white py-3 -mx-6 px-6">
                        ...
                        <Button
                            type="submit"
                            disabled={isSubmitting || createTimetableMutation.isPending}
                        >
